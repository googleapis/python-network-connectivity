...
from google.cloud.networkconnectivity_v1.services.policy_based_routing_service import PolicyBasedRoutingServiceAsyncClient
...
from google.cloud.networkconnectivity_v1.services.policy_based_routing_service import transports
...
@pytest.mark.parametrize("client_class,transport_name", [
    (PolicyBasedRoutingServiceClient, "grpc"),
...
async def test_list_policy_based_routes_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_policy_based_routes(
            policy_based_routing.ListPolicyBasedRoutesRequest(),
            parent='parent_value',
        )
...
def test_list_policy_based_routes_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, policy_based_routing.PolicyBasedRoute)
                   for i in results)
...
def test_get_policy_based_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_policy_based_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = policy_based_routing.PolicyBasedRoute(
            ...
            next_hop_ilb_ip='next_hop_ilb_ip_value',
        )
...
async def test_get_policy_based_route_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.get_policy_based_route(
            policy_based_routing.GetPolicyBasedRouteRequest(),
            name='name_value',
        )
...
def test_create_policy_based_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_policy_based_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_policy_based_route_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_policy_based_route(
            parent='parent_value',
            policy_based_route=policy_based_routing.PolicyBasedRoute(virtual_machine=policy_based_routing.PolicyBasedRoute.VirtualMachine(tags=['tags_value'])),
...
async def test_create_policy_based_route_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_policy_based_route(
            policy_based_routing.CreatePolicyBasedRouteRequest(),
            parent='parent_value',
            policy_based_route=policy_based_routing.PolicyBasedRoute(virtual_machine=policy_based_routing.PolicyBasedRoute.VirtualMachine(tags=['tags_value'])),
            policy_based_route_id='policy_based_route_id_value',
...
def test_delete_policy_based_route(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_policy_based_route),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_delete_policy_based_route_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_policy_based_route(
            policy_based_routing.DeletePolicyBasedRouteRequest(),
            name='name_value',
        )
...
def test_transport_get_channel():
    ...
    transport = transports.PolicyBasedRoutingServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    transport = PolicyBasedRoutingServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.parametrize(
    ...
    [
        (transports.PolicyBasedRoutingServiceGrpcTransport, grpc_helpers),
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PolicyBasedRoutingServiceGrpcTransport, transports.PolicyBasedRoutingServiceGrpcAsyncIOTransport])
def test_policy_based_routing_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_policy_based_route_path():
    project = "oyster"
    location = "nudibranch"
    policy_based_route = "cuttlefish"
    expected = "projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}".format(project=project, location=location, policy_based_route=policy_based_route, )
    actual = PolicyBasedRoutingServiceClient.policy_based_route_path(project, location, policy_based_route)
    assert expected == actual
