...
from google.cloud.networkconnectivity_v1.services.hub_service import HubServiceAsyncClient
...
from google.cloud.networkconnectivity_v1.services.hub_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_deactivate_spoke(transport: str = 'grpc', request_type=hub.DeactivateSpokeRequest):
    client = HubServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.deactivate_spoke),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_deactivate_spoke_async(transport: str = 'grpc_asyncio', request_type=hub.DeactivateSpokeRequest):
    client = HubServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_deactivate_spoke_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.deactivate_spoke(
            name='name_value',
        )
...
def test_activate_spoke(transport: str = 'grpc', request_type=hub.ActivateSpokeRequest):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.activate_spoke),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_activate_spoke_async(transport: str = 'grpc_asyncio', request_type=hub.ActivateSpokeRequest):
    client = HubServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_activate_spoke_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.activate_spoke(
            name='name_value',
        )
