...
class HubServiceTransport(abc.ABC):
    ...
    @property
    def list_hubs(self) -> typing.Callable[
            [hub.ListHubsRequest],
            typing.Union[
                hub.ListHubsResponse,
                typing.Awaitable[hub.ListHubsResponse]
            ]]:
        raise NotImplementedError()

    @property
    def get_hub(self) -> typing.Callable[
            [hub.GetHubRequest],
            typing.Union[
                hub.Hub,
                typing.Awaitable[hub.Hub]
            ]]:
        raise NotImplementedError()

    @property
    def create_hub(self) -> typing.Callable[
    ...
    @property
    def update_hub(self) -> typing.Callable[
    ...
    @property
    def delete_hub(self) -> typing.Callable[
    ...
    @property
    def list_spokes(self) -> typing.Callable[
    ...
    @property
    def get_spoke(self) -> typing.Callable[
            [hub.GetSpokeRequest],
            typing.Union[
                hub.Spoke,
                typing.Awaitable[hub.Spoke]
            ]]:
        raise NotImplementedError()

    @property
    def create_spoke(self) -> typing.Callable[
    ...
    @property
    def update_spoke(self) -> typing.Callable[
    ...
    @property
    def delete_spoke(self) -> typing.Callable[
