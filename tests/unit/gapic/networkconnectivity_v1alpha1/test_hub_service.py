...
from google.cloud.networkconnectivity_v1alpha1.services.hub_service import (
...
def test_hub_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.networkconnectivity_v1alpha1.services.hub_service.transports.HubServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_get_spoke(transport: str = "grpc", request_type=hub.GetSpokeRequest):
    ...
    assert response.linked_interconnect_attachments == [
...
def test_hub_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.networkconnectivity_v1alpha1.services.hub_service.transports.HubServiceTransport.__init__"
    ) as Transport:
